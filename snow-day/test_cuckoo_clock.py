...
def my_fizz_buzz_cuckoo_clock(time):
...
def test_randos():
    """Test for randoms."""
    import random
    """first, I want to be sure that 0, 15, 30, and 45 do get included regardless of whatever other completely random numbers come up in subsequent tests."""
